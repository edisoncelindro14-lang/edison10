...
import { money, NETWORK_COLORS, FALLBACK_PRODUCTS,
  getProductRating, getProductReviewCount, getProductBadge, getDiscountPercent, getFinalPrice, computeWalletBalance } from "../lib/helpers";
...
export default function ProductDetail({ productId }) {
  ...
  const walletBalance = currentMember
    ? computeWalletBalance(transactions.filter(t => t.member_id === currentMember.id))
    : 0;
